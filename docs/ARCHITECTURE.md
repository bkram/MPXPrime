...
20. Stereo encoder (M/S encoding, 38 kHz DSB-SC subcarrier)
    - **Rule Breaker** (`mpx_rulebreaker_enabled`, experimental, default off): SSB-leaning
      ...
      `--verify-rulebreaker` (sideband asymmetry matches theory, coherent separation
