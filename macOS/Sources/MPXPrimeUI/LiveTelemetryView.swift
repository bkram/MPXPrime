...
//
// The isolation pattern for an @Observable-macro telemetry object (both apps
// use it: Studio's LiveTelemetry and the Meter's MeterTelemetry).
...
// dependency-tracking cost stays flat over long sessions (the ObservableObject bridge's
...
// which is why the legacy LiveTelemetryView wrapper was removed once both
// apps migrated).
